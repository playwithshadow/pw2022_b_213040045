...
$adm = query("SELECT * FROM tbl_login NATURAL JOIN tbl_level WHERE level = 'anggota'")[0];
    ...
    if (ubah($_POST) > 0) {
        echo "
            <script>
                ...
                document.location.href = 'profileanggota.php';
            </script>
        ";
    } else {
        echo "
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 py-5">
                <div class="card shadow-lg">
                    <div class="fw-bolder fs-4 card-header text-center bg-primary text-light">Form Ubah Anggota - VAN TECH</div>
                    <div class="card-body">
