        ...
        <div class="col-6">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" id="gambar" name="gambar" onchange="previewImage();" placeholder="Masukkan Gambar" value="<?= $mhs['gambar']; ?>">
                </div>
